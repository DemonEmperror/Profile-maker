...
def index():
    if request.method == 'POST':
        ...
        session['design'] = 'display_profile'  # Changed from 'd1' to 'display_profile'
...
def download():
    try:
        ...
        design = session.get('design', 'display_profile')  # Changed default from 'd1' to 'display_profile'
...
def switch_design():
    try:
        ...
        if design not in ['display_profile', 'd1', 'd2', 'd3']:  # Added 'display_profile' to valid designs
